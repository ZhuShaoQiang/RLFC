...
def main():
    ...
    env = RecordRewWrapper(env, rew_log_dir=f"./ckp/log/rew/{params['env_name']}/ppo_fvrl3_coef_2_50w", avg_n=10)
    ...
    model = FVRL_PPO_3(
        ...
        verbose=1, tensorboard_log=f"./ckp/log/{params['env_name']}_ppo_fvrl3_coef_2_30w/", gae_lambda=0.0,
    )
    print(model.policy)
