...
params = {
    ...
    "LOGS_PATH": "./ckp/LOGS/DQNadventure_005_rlfc_4_12/",
    "SAVE_PATH": "./ckp/OUT/DQNadventure_005_rlfc_4_12/",
    "SCORER_PATH": "./ckp/OUT/Adventure_DQN/scorer_4_12_0.05.pth",  # 打分器是一样的，可以重用
}
